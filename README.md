...
<h3>For the above features to work, there will be an admin backend with the following features:</h3>
<ul>
<li>Admin login page where admin can change password after login if he wants to</li>

<li>A master list of food items available for purchase</li>

<li>A functionality to add or remove food items</li>
</ul>
